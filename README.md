...
**Homework 1.2** — First steps with ESP32-S3. Basic breadboard setup with an LED connected to the development board, verifying the toolchain and hardware connectivity.

### [Blink](Blink/)
**Homework 1.3** — LED blink program demonstrating two approaches:
...
**Homework 1.4** — Two-button LED controller with hardware interrupts:
...
**Homework 1.6** — Light level measurement using an LDR and the ESP32-S3 ADC:
...
**Final project** — Automatic light-activated relay on ESP32-S3:
